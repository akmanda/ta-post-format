...
TA post format plugin is a plugin to add functionality of WordPress post format. 
...
Is it work to all themes ?
This plugin should work to all themes. But this plugin guarantee to work at Themes Awesome WordPress Theme